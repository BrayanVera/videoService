...
List<String> generesToList(List<dynamic> genreIds) => genreIds.map((id) => _genreMap[id]).toList();

String getGenereValues(List<dynamic> genereIds){

  StringBuffer buffer = new StringBuffer();

  buffer.writeAll(generesToList(genereIds), ", ");
